...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => ''.e(route('dashboard.trabajador')).'','active' => request()->routeIs('dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('dashboard.trabajador')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard'))]); ?>
                        <span class="text-2xl text-black font-semibold font-serif"><?php echo e(__('Oficio Web')); ?></span>
...
<?php /**PATH C:\laragon\www\app-oficioweb\resources\views\navigation-menu.blade.php ENDPATH**/ ?>