                ...
                <form action="<?php echo e(route('publicacion.store')); ?>" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Tiempo Completo" <?php echo e(old('estado') == 'Tiempo Completo' ? 'selected' : ''); ?>>Disponible</option>
                            <option value="Medio Tiempo" <?php echo e(old('estado') == 'Medio Tiempo' ? 'selected' : ''); ?>>Ocupado</option>
                        </select>
                    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\oficio_web\resources\views/publicaciones/create.blade.php ENDPATH**/ ?>