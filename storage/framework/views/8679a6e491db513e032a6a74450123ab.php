                ...
                <div class="bg-gray-100 p-6 rounded-lg shadow-md h-auto overflow-auto">
                    ...
                    <?php if($trabajador->antecedentes): ?>
                        <p class="mb-4">
                            ...
                            <a href="<?php echo e(Storage::url($trabajador->antecedentes)); ?>" target="_blank" class="text-blue-500 hover:text-[#9DBEBB]">
                                Ver archivo
                            </a>
                        </p>
                    <?php else: ?>
                            ...
                            <ul class="space-y-4">
                                <?php $__currentLoopData = $opiniones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opinion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="p-4 bg-gray-100 border border-gray-300 rounded-lg">
                                        ...
                                        <!--<p class="text-sm text-gray-500"> <?php echo e(\Carbon\Carbon::parse($opinion->fecha)->format('d/m/Y')); ?></p>-->
                                        <p class="text-sm text-gray-500"> <?php echo e(\Carbon\Carbon::parse($opinion->fecha)->format('d F Y')); ?></p>
                                    </li>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\oficio_web\resources\views/dashboard/trabajador.blade.php ENDPATH**/ ?>