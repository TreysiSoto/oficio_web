     ...
     <?php $__env->slot('form', null, []); ?> 
        ...
        <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                <!-- Entrada para archivo de Foto de Perfil -->
            ...
            <?php if(Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::emailVerification()) && ! $this->user->hasVerifiedEmail()): ?>
                ...
                <?php if($this->verificationLinkSent): ?>
                    <p class="mt-2 font-medium text-sm text-green-600">
                        <?php echo e(__('Se ha enviado un nuevo enlace de verificación a tu correo electrónico.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\app-oficioweb\resources\views\profile\update-profile-information-form.blade.php ENDPATH**/ ?>