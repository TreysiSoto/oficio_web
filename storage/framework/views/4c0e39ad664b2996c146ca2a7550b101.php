...
<label <?php echo e($attributes->merge(['class' => 'block font-medium text-lg text-gray-700'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH C:\laragon\www\app-oficioweb\resources\views\components\label.blade.php ENDPATH**/ ?>