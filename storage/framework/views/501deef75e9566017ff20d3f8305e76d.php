                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-8">
                        ...
                        <p class="mb-4">
                            ...
                            <a href="<?php echo e(Storage::url($empleador->antecedentes)); ?>" target="_blank" class="text-blue-500 hover:text-blue-700">
                                Ver archivo
                            </a>
                        </p>
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                            ...
                            <div class="block justify-end mb-4">
                                <a href="<?php echo e(route('publicacion.create')); ?>" class="bg-[#031926] text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
