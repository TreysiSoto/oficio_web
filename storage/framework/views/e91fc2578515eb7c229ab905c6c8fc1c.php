...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white p-4 rounded-lg shadow-md w-72 ml-0">
        ...
        <?php if(isset($trabajadores) && $trabajadores->isNotEmpty()): ?>
            <h4 class="mt-4 text-md font-semibold">Trabajadores encontrados</h4>
            <ul class="mt-3 text-sm">
                <?php $__currentLoopData = $trabajadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trabajador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e($trabajador->nombres); ?> - <?php echo e($trabajador->oficio->nombre); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        <?php elseif(isset($trabajadores)): ?>
            <p class="text-sm">No se encontraron trabajadores que coincidan con la búsqueda.</p>
        <?php endif; ?>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            <?php endif; ?>
                             ...
                             <?php if($empleador->antecedentes): ?>
                                   <p><strong>Antecedentes:</strong>
                                       <a href="<?php echo e(Storage::url($empleador->antecedentes)); ?>" target="_blank" class="text-blue-500 hover:text-blue-700">Ver archivo</a>
                                   </p>
                            <?php else: ?>
                                <p><strong>Antecedentes:</strong> No especificados</p>
                            <?php endif; ?>   
                                ...
                                <form action="<?php echo e(route('empleador.subirAntecedentes', $empleador->id)); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <!-- Botón de carga de archivo oculto y asociado al botón visible -->
                                    <label for="antecedentes" class="mt-4 px-4 py-2 bg-[#031926] text-white rounded-lg cursor-pointer hover:bg-blue-700">
                                        Subir Antecedentes
                                    </label>
                                    <input type="file" name="antecedentes" id="antecedentes" accept="application/pdf, image/*" class="hidden" onchange="this.form.submit()">
                                </form>
                                
                                <div class="flex justify-end mb-4">
                                    <a href="<?php echo e(route('publicacion.create')); ?>" class="bg-[#031926] text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition">
                                    ...
                                    <div class="space-y-6">
                                        <?php $__currentLoopData = $misPublicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $publicacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="p-4 border rounded-lg bg-gray-50">
                                                <h3 class="text-lg font-semibold"><?php echo e($publicacion->titulo); ?></h3>
                ...
                <div class="lg:col-span-3 space-y-3">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <!--<h3 class="text-xl font-semibold mb-4">Publicaciones de Empleadores</h3>-->
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\app-oficioweb\resources\views\dashboard\empleador.blade.php ENDPATH**/ ?>